...
| [`J1_COLLABORATOR_IMPLEMENTATION_RECEIPT_V1.md`](J1_COLLABORATOR_IMPLEMENTATION_RECEIPT_V1.md) | **QUALIFICATION CANDIDATE — NOT AUTHORIZED**; 3 of 7 collaborators real |
