...
|---|---|---|---|---|---|
| **J1** | Fair episode comparator | J-RQ3 | PLANNED / NOT AUTHORIZED | NONE | [protocol](j1/J1_FAIR_EPISODE_COMPARATOR_PROTOCOL_V1.md) and [pre-registration](j1/J1_PRE_REGISTRATION_V1.md) drafted; **not ready to freeze** — 1 open decision (zero-reference handling in the paired contrast) |
