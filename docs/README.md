...
| `docs/journal-extension/` | the prospective V2 / journal-extension control plane. Grants no experimental authorization; V1 remains authoritative for what V1 measured | 5 |
