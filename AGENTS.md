...
8. Prefer small, reviewable changes over broad rewrites. Treat the content-only,
   protected `legacy` branch and `archive/legacy-v0-tree` tag as immutable.
   Restoring archived files to the active tree requires an explicit
